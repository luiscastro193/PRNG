...
public:
	...
	static constexpr unsigned output_bits = std::numeric_limits<double>::digits;
	
	static constexpr result_type min() noexcept { return 0; }
	static constexpr result_type max() noexcept { return (result_type(1) << output_bits) - 1; }
